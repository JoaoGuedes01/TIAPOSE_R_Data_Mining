# Script demonstration of a growing window. Can easily be adapted for a rolling window
...
d1=read.table("store.csv",sep=";",header=TRUE,na.strings="?",stringsAsFactors=TRUE)
d1=d1[,2] # vector of numeric
